...
# Account Information
to = 'xxx@xx.com' # Email to send to.
gmail_user = 'yyy@yy.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'your-yyy@yy.com-password' # Gmail password.
# Make sure you have open stmp ~~
smtpserver = smtplib.SMTP('smtp.yy.com', 587) # Server to use.
...
print("ip_lines={}".format(ip_lines))
...
#==================================
ipaddr_a = split_line_a[split_line_a.index('via')+1]
